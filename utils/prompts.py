...
def get_system_prompt(persona_name):
    """Returns a cleaned system prompt for general chatbot usage."""
    raw = PROMPTS.get(persona_name, "You are a helpful assistant.")
    # Remove template formatting variables for general chatbot safety
    import re
    cleaned = re.sub(r'\{[^}]*\}', '', raw)
    # Also clean double newlines if any
